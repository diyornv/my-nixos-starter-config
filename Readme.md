> [!IMPORTANT]  
> This repo is a little out of date at the moment, and is pending a refactor. Please check official documentation for NixOS and home-manager to make sure you're doing things right. See https://github.com/diyornv/my-nixos-starter-config for more info.
...
```bash
# For minimal version
nix flake init -t github:diyornv/my-nixos-starter-config#minimal

# For standard version
nix flake init -t github:diyornv/my-nixos-starter-config#standard
```
...
[configuration repo](https://github.com/diyornv/nix-config) for ideas.
...
Please [let me know](https://github.com/diyornv/my-nixos-starter-config/issues)
